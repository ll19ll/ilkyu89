...
public class ReplyController {
	...
	/**************************************************************
	 * 댓글 글목록 구현하기 * @return List<ReplyVO> 참고 : @PathVariable는 URI의 경로에서 원하는 데이터를
	 * 추출하는 용도의 어노테이션. 현재 요청 URL : http://localhost:8080/replies/all/게시판글번호.do 예전 요청
	 * URL : http://localhost:8080/replies/replyList.do?b_num=게시판글번호
	 **************************************************************/
	...
	/*
	 * 댓글 수정 구현 참고 : REST 방식에서 UPDATE 작업은 PUT,PATCH방식을 이용해서 처리. 전체 데이터를 수정하는 경우에는
	...
	/*
	 * 댓글 삭제 구현 @return 참고 : REST 방식에서 DELETE 작업은 DELETE방식을 이용해서 처리.
	 */
